    ...
    <div>
        <section class="w-full bg-white">
            <div class="px-8 py-12 mx-auto max-w-7xl ">
                <div class="grid grid-cols-2 gap-10 mb-3 md:grid-cols-3 lg:grid-cols-6 lg:gap-20 ">
                    <div class="col-span-1">
                        <a href="#_" class="text-xl font-black leading-none text-gray-900 select-none logo">Ntuananh</a>
                        <!-- <p class="my-4 text-xs leading-normal text-gray-500">
                            Beautifully hand-crafted components to help you build amazing pages.
                        </p> -->
                    </div>
                    <nav class="col-span-1">
                        <p class="mb-3 text-xs font-bold tracking-wider text-gray-900 uppercase font-bold">Product</p>
                        <a href="#"
                    ...
                    <nav class="col-span-1">
                        <p class="mb-3 text-xs font-bold tracking-wider text-gray-900 uppercase font-bold">About</p>
                        <a href="#"
                    ...
                    <nav class="col-span-1">
                        <p class="mb-3 text-xs font-bold tracking-wider text-gray-900 uppercase font-bold">Contact</p>
                        <a href="#"
                    ...
                    <nav class="col-span-1">
                        <p class="mb-3 text-xs font-bold tracking-wider text-gray-900 uppercase font-bold">Services</p>
                        <a href="#"
                            class="flex mb-3 text-sm font-medium text-gray-500 transition hover:text-gray-700 md:mb-2 hover:text-primary">Web
                            development</a>
                        <a href="#"
                            class="flex mb-3 text-sm font-medium text-gray-500 transition hover:text-gray-700 md:mb-2 hover:text-primary">Mobile
                            App development</a>
                        <a href="#"
                            class="flex mb-3 text-sm font-medium text-gray-500 transition hover:text-gray-700 md:mb-2 hover:text-primary">UX/UI
                            Design</a>
                        <a href="#"
                            class="flex mb-3 text-sm font-medium text-gray-500 transition hover:text-gray-700 md:mb-2 hover:text-primary">SEO</a>
                        <a href="#"
                            class="flex mb-3 text-sm font-medium text-gray-500 transition hover:text-gray-700 md:mb-2 hover:text-primary">Content
                            writing</a>
                    </nav>
                    <nav class="col-span-1">
                        <p class="mb-3 text-xs font-bold tracking-wider text-gray-900 uppercase font-bold">Social Media</p>
                        <a href="#"
                            class="flex mb-3 text-sm font-medium text-gray-500 transition hover:text-gray-700 md:mb-2 hover:text-primary">Instagram</a>
                        <a href="#"
                            class="flex mb-3 text-sm font-medium text-gray-500 transition hover:text-gray-700 md:mb-2 hover:text-primary">Facebook</a>
                        <a href="#"
                            class="flex mb-3 text-sm font-medium text-gray-500 transition hover:text-gray-700 md:mb-2 hover:text-primary">Twitter</a>
                        <a href="#"
                            class="flex mb-3 text-sm font-medium text-gray-500 transition hover:text-gray-700 md:mb-2 hover:text-primary">Linkedin</a>
                    </nav>
                </div>
                    <div
                        class="flex flex-col items-start justify-between pt-4 border-t border-gray-200 md:flex-row md:items-center">
                        <p class="mb-6 text-sm text-left text-gray-600 md:mb-0">© Copyright 2024 Tails. All Rights
                            Reserved.</p>
